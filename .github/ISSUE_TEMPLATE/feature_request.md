...
about: Suggest a new feature or enhancement for tpc
title: "[FEATURE] "
labels: enhancement
assignees: ""
---
...
```bash
# Example command or interaction flow
tpc <new-command>
```

### Expected Behavior

Describe what should happen when using this feature.
...
Explain how this feature would benefit tpc users:
